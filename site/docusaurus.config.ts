...
const config: Config = {
  title: 'Things',
  tagline: 'All of Factorio\'s cursed black magic, in one handy dandy spellbook.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://project-cybersyn.github.io',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} The Things Authors. Built with Docusaurus.`,
    },
    prism: {
