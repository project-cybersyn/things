...
---@field public virtual_orientation? Core.Orientation The virtual orientation to set on the created Thing if any.
...
function CreateOp:resolve(frame)
	...
	if self.virtual_orientation then
		local vo_class = orientation_lib.get_class(self.virtual_orientation)
		thing:virtualize_orientation(vo_class)
		thing:set_orientation(self.virtual_orientation, true, true)
	end
